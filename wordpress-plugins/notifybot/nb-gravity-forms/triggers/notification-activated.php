...
class Notification_Activated extends Trigger {

	public $id = 'gf-notification-activated';
	...
	public function label() {
		return 'Notification Activated';
	}

	public function placeholder() {
		return 'Notification ID {notification_id} activated on form {form_title} by: {user}';
	}
	...
	public function listeners() {
		add_action( 'gform_pre_notification_activated', array( $this, 'triggered' ), 10, 2 );
	}
...
Triggers::register( new Notification_Activated() );