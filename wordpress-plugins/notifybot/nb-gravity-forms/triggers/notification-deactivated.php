...
class Notification_Deactivated extends Trigger {

	public $id = 'gf-notification-deactivated';
	...
	public function label() {
		return 'Notification Deactivated';
	}

	public function placeholder() {
		return 'Notification ID {notification_id} deactivated from form {form_title} by: {user}';
	}
	...
	public function listeners() {
		add_action( 'gform_pre_notification_deactivated', array( $this, 'triggered' ), 10, 2 );
	}
...
Triggers::register( new Notification_Deactivated() );