...
class Form_Trashed extends Trigger {

	public $id = 'gf-form-trashed';
	...
	public function listeners() {
		add_action( 'gform_post_form_trashed', array( $this, 'triggered' ), 10, 1 );
	}
...
Triggers::register( new Form_Trashed() );