...
class Entry_Added extends Trigger {

	public $id = 'gf-entry-added';
	...
	public function placeholder() {
		return 'Entry ID {entry_id} has been added to {form_title}';
	}
	...
	public function listeners() {
		add_action( 'gform_post_add_entry', array( $this, 'triggered' ), 10, 2 );
	}
...
Triggers::register( new Entry_Added() );