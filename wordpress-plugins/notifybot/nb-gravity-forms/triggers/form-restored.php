...
class Form_Restored extends Trigger {

	public $id = 'gf-form-restored';
	...
	public function placeholder() {
		return 'Form restored from trash: {form_id}';
	}
	...
	public function listeners() {
		add_action( 'gform_post_form_restored', array( $this, 'triggered' ), 10, 1 );
	}
...
Triggers::register( new Form_Restored() );