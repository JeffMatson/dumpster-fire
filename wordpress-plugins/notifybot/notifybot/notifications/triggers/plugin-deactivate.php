...
class Plugin_Deactivate extends Trigger {

	public $id          = 'plugin-deactivate';
	public $depends_on  = 'plugin';
	public $placeholder = 'Plugin {plugin_name} was deactivated by {user}';
	public $label       = 'Plugin Deactivated';
	...
	public function listeners() {
		add_action( 'deactivated_plugin', array( $this, 'triggered' ), 10, 2 );
	}
...
Triggers::register( new Plugin_Deactivate() );