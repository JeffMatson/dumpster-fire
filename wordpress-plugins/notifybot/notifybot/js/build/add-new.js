...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducersTriggersJsx = __webpack_require__(181);
	
	var _reducersTriggersJsx2 = _interopRequireDefault(_reducersTriggersJsx);
	
	var store = (0, _redux.createStore)(_reducersTriggersJsx2['default']);
	
	var TriggerContainer = _react2['default'].createClass({
	    displayName: 'TriggerContainer',
	
	    clickedStuff: function clickedStuff() {
	        store.dispatch(addTrigger());
	        console.log(store);
	    },
	    render: function render() {
	        return _react2['default'].createElement(
	            'div',
	            { onClick: this.clickedStuff() },
	            'Hello World'
	        );
	    }
	});
	
	var TriggerItem = _react2['default'].createClass({
	...
	_reactDom2['default'].render(_react2['default'].createElement(
	    ...
	    { store: store },
	    _react2['default'].createElement(TriggerContainer, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$assign = __webpack_require__(182)['default'];
	...
	var triggers = function triggers(state, action) {
