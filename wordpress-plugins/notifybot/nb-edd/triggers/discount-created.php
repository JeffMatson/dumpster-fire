...
class Discount_Created extends Trigger {

	public $id = 'edd-discount-created';
	...
	public function placeholder() {
		return 'Discount code {discount_code} created by {user}';
	}
	...
	public function listeners() {
		add_action( 'edd_post_insert_discount', array( $this, 'triggered' ), 10, 1 );
	}
...
Triggers::register( new Discount_Created() );