...
class Payment_Deleted extends Trigger {

	public $id = 'edd-payment-deleted';
	...
	public function placeholder() {
		return 'Payment ID {payment_id} was deleted by {user}';
	}
	...
	public function listeners() {
		add_action( 'edd_payment_delete', array( $this, 'triggered' ), 10, 1 );
	}
...
Triggers::register( new Payment_Deleted() );